...
""" Summary:
            1)When you write generator within function then it becomes generator function.
            2)Generator is used to optimized the memory usage and increases the execution speed.
            3)The major advantage of using generators is, it saves the state of generator function,thus 
            we can reuse the previous state of function.
